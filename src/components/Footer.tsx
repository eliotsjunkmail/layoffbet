...
export const Footer = () => (
  <>
    ...
    <div className="text-center text-xs text-gray-400 dark:text-slate-500 py-3 border-t border-gray-200 dark:border-slate-800 px-4 leading-relaxed max-w-2xl mx-auto">
      All predictions and bets use virtual coins with no real-world or monetary value — not financial, legal, or gambling advice. An anonymous open forum; posts by current and former employees are user-generated and not endorsed by Layoff Chat.
    </div>
  </>
)
