        ...
        <div className="max-w-md sm:max-w-5xl mx-auto w-full px-4 sm:px-8 flex items-center justify-between h-14">
          <Link to="/" className="flex items-center gap-2 flex-shrink-0">
            ...
            <div className="flex items-baseline gap-0.5">
              ...
              <span className="text-xs text-gray-400 dark:text-slate-500 sm:ml-2">v1.10</span>
            </div>
          </Link>
            ...
            {currentUser ? (
              <>
                ...
                <button
                  ...
                  className="flex items-center gap-1 ml-1 bg-gray-100 dark:bg-slate-800 hover:bg-gray-200 dark:hover:bg-slate-700 rounded-full px-3 py-1.5 transition-colors"
                >
