            ...
            {currentUser ? (
              ...
              <>
                ...
                <button
                  ...
                  className="px-3 py-1.5 rounded-lg font-medium text-sm border border-gray-300 dark:border-slate-600 text-gray-500 dark:text-slate-400 hover:text-gray-700 dark:hover:text-slate-200 hover:border-gray-400 dark:hover:border-slate-500 transition-colors"
                >
                  + Bet
                </button>
                <Link
