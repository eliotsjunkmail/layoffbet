  ...
  return (
    <>
      <header className="sticky top-0 z-40 bg-white/95 dark:bg-slate-950/95 backdrop-blur border-b border-gray-200 dark:border-slate-800">
        <div className="max-w-md sm:max-w-5xl mx-auto w-full px-2 sm:px-8 flex items-center justify-between h-14">
          <Link to="/" className="flex items-center gap-2 flex-shrink-0 min-w-0">
            <div className="flex items-baseline gap-0.5">
              <span className="font-semibold text-gray-600 dark:text-slate-300 text-xs sm:text-sm tracking-tight">Layoff</span>
              <span className="font-black text-blue-600 dark:text-blue-400 text-xs sm:text-sm tracking-tight">Bet</span>
              <span className="text-xs text-gray-400 dark:text-slate-500 ml-1 hidden sm:inline">v1.56</span>
            </div>
          </Link>
            ...
            {currentUser && !hasDefaultPassword ? (
              <>
                ...
                <button
                  ...
                  className="flex items-center gap-0.5 sm:gap-1 sm:ml-1 bg-gray-100 dark:bg-slate-800 hover:bg-gray-200 dark:hover:bg-slate-700 rounded-full px-2 sm:px-3 py-1 sm:py-1.5 transition-colors"
                >
