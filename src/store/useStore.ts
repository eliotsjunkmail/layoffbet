...
const SEED_EVENTS: Event[] = [
  ...
  // BNY predictions
  {
    ...
    expiresAt: futureDate(45), status: 'active', creatorId: 'user-eliot', creatorName: 'eliotsjunkmail@gmail.com',
    yesPool: 510, noPool: 190, outcome: null, createdAt: pastDate(8), viewCount: 7241, shareCount: 0,
  },
  {
    ...
    expiresAt: futureDate(60), status: 'active', creatorId: 'user-eliot', creatorName: 'eliotsjunkmail@gmail.com',
    yesPool: 380, noPool: 220, outcome: null, createdAt: pastDate(6), viewCount: 5812, shareCount: 0,
  },
  {
    ...
    yesPool: 440, noPool: 160, outcome: null, createdAt: pastDate(5), viewCount: 6634, shareCount: 0,
  },
  {
    ...
    expiresAt: futureDate(30), status: 'active', creatorId: 'user-eliot', creatorName: 'eliotsjunkmail@gmail.com',
    yesPool: 290, noPool: 210, outcome: null, createdAt: pastDate(4), viewCount: 4109, shareCount: 0,
  },
  {
    ...
    yesPool: 330, noPool: 270, outcome: null, createdAt: pastDate(3), viewCount: 3887, shareCount: 0,
  },
  {
    ...
    yesPool: 260, noPool: 240, outcome: null, createdAt: pastDate(2), viewCount: 3421, shareCount: 0,
  },
  {
    ...
    yesPool: 310, noPool: 290, outcome: null, createdAt: pastDate(2), viewCount: 2988, shareCount: 0,
  },
  {
    ...
    yesPool: 420, noPool: 180, outcome: null, createdAt: pastDate(1), viewCount: 5203, shareCount: 0,
  },
  {
    ...
    yesPool: 680, noPool: 120, outcome: 'yes', createdAt: pastDate(45), viewCount: 9341, shareCount: 0,
  },
  {
    ...
    yesPool: 350, noPool: 250, outcome: null, createdAt: pastDate(1), viewCount: 4102, shareCount: 0,
  },
    ...
    (set, get) => ({
      ...
      recordShare: (eventId) => {
        ...
        set(s => ({
          ...
          ...(currentUser && {
            currentUser: { ...currentUser, coins: currentUser.coins + 100 },
            users: s.users.map(u => u.id === currentUser.id ? { ...u, coins: u.coins + 100 } : u),
          }),
        }))
      },
