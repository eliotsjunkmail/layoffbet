      ...
      {(currentUser && userStats) || !currentUser ? (
        <div className="mb-5 -mx-4 px-4 pb-4">
          <div className="flex justify-center">
            <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg sm:rounded-xl p-2.5 sm:p-4 text-center shadow-sm flex flex-col w-full max-w-sm">
