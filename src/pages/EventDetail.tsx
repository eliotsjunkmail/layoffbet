...
export const EventDetail = () => {
  ...
  return (
    <Layout>
      ...
      {toast && (
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 bg-slate-800 border border-slate-700 text-slate-100 px-5 py-2.5 rounded-md text-sm font-medium shadow-lg z-50">
          {toast}
        </div>
      )}
    </Layout>
